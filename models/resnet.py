...
def get_block(num_channels, norm_layer):
    layers = [
...
class ResNet(nn.Module):
    def __init__(self, num_input_channels=1, num_output_channels=1, num_blocks=16, num_channels=1, need_residual=True, act_fun='ReLU', need_sigmoid=True, norm_layer=nn.BatchNorm2d, pad='reflection'):
        '''
        ...
        for i in range(num_blocks):
            layers += [s(*get_block(num_channels, norm_layer))]
